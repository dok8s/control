...
function showObj(Obj){
                if (document.getElementById("showobj")==null){
                    document.body.innerHTML=document.body.innerHTML+"<div id=showobj></div>";
                }
                document.getElementById("showobj").innerHTML="<xmp>";
                
                for(var variable in Obj){
                    try{
                        document.getElementById("showobj").innerHTML=document.getElementById("showobj").innerHTML+"name:"+variable+"==== value:"+Obj[variable]+"<br>";
                    }catch(e){}
                }
                document.getElementById("showobj").innerHTML+="</xmp>";
            }