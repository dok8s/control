...
if($level==-2){
	echo "<table id=\"glist_table\" border=\"0\" cellspacing=\"1\" cellpadding=\"0\"  bgcolor=\"006255\" class=\"m_tab\" width=\"778\">
		<tr class='m_title_ft'><td align='middle' width='84'>超管</td><td width='126'>最后活动时间</td><td width='390'>操作</td><td width='173'>登陆IP</td></tr>\r\n  ";
				...
				$sql = "select username,logtime,context,logip from web_mem_log where level='-2'  and username!='' and username!='system' order by logtime desc limit 0,50";//and LEFT(username,6)!='system' 
				$result = mysql_query( $sql );
...
{					$class='';
		...
		<tr class='m_title_ft'><td align='middle' width='84'>会员</td><td width='126'>最后活动时间</td><td width='390'>操作</td><td width='173'>登陆IP</td></tr>\r\n  ";
				...
				echo "用户登入成功";
				echo "</td>\r\n\t<td align=right width=\"173\">";
				echo "<a href='http://ip138.com/ips138.asp?action=2&ip=$logip' target=_blank>$logip</a>";
				echo "</td>\r\n  </tr>\r\n  ";
				echo "</table>\r\n<br>\r\n";
}
