...
case 1 :
				...
				if($row['LineType']==1){
					$row['LineType']=2;
					$rate=$row['M_Rate'];
					$gwin = $row['BetScore'] * $rate - $row['BetScore'];
				}
				switch ( $row['LineType'] )
				{
				case 2 :
								...
								if ( strstr( $team, "�ϰ�" ) )
								{
												...
												$bottom1 = "<font color=red>-&nbsp;</font><font color=gray>[�ϰ�]</font>&nbsp;";
												$bottom1_en = "<font color=red>-&nbsp;</font><font color=gray>[1st]</font>&nbsp;";
								}
								else if ( strstr( $team, "�°�" ) )
								{
												$bottom1_tw = "<font color=red>-&nbsp;</font><font color=gray>[�W�b]</font>&nbsp;";
												$bottom1 = "<font color=red>-&nbsp;</font><font color=gray>[�°�]</font>&nbsp;";
												$bottom1_en = "<font color=red>-&nbsp;</font><font color=gray>[2st]</font>&nbsp;";
								}
								else if ( strstr( $team, "��1��" ) )
								{
												$bottom1_tw = "<font color=red>-&nbsp;</font><font color=gray>[��1�`]</font>&nbsp;";
												$bottom1 = "<font color=red>-&nbsp;</font><font color=gray>[��1��]</font>&nbsp;";
												$bottom1_en = "<font color=red>-&nbsp;</font><font color=gray>[Q1]</font>&nbsp;";
								}
								else if ( strstr( $team, "��2��" ) )
								{
												$bottom1_tw = "<font color=red>-&nbsp;</font><font color=gray>[��2�`]</font>&nbsp;";
												$bottom1 = "<font color=red>-&nbsp;</font><font color=gray>[��2��]</font>&nbsp;";
												$bottom1_en = "<font color=red>-&nbsp;</font><font color=gray>[Q2]</font>&nbsp;";
								}
								else if ( strstr( $team, "��3��" ) )
								{
												$bottom1_tw = "<font color=red>-&nbsp;</font><font color=gray>[��3�`]</font>&nbsp;";
												$bottom1 = "<font color=red>-&nbsp;</font><font color=gray>[��3��]</font>&nbsp;";
												$bottom1_en = "<font color=red>-&nbsp;</font><font color=gray>[Q3]</font>&nbsp;";
								}
								else if ( strstr( $team, "��4��" ) )
								{
												$bottom1_tw = "<font color=red>-&nbsp;</font><font color=gray>[��4�`]</font>&nbsp;";
												$bottom1 = "<font color=red>-&nbsp;</font><font color=gray>[��4��]</font>&nbsp;";
								...
								$mysql = "update web_db_io set auth_code='".$auth_code."',vgold=0,result_type=0,m_result=0,a_result=0,result_c=0,result_a=0,result_s=0,status=0,gwin='{$gwin}',m_rate='{$rate}',mtype='".$mtype."',middle='".$lines2."',middle_tw='".$lines2_tw."',middle_en='".$lines2_en.( "' where id=".$id );
				...
				case 3 :
								...
								$mysql = "update web_db_io set auth_code='".$auth_code."',vgold=0,m_place='{$m_place_en}',result_type=0,m_result=0,a_result=0,result_c=0,result_a=0,result_s=0,status=0,gwin='{$gwin}',m_rate='{$rate}',mtype='".$mtype."',middle1='".$lines2."',middle1_tw='".$lines2_tw."',middle1_en='".$lines2_en."',middle2='".$lines2."',middle2_tw='".$lines2_tw."',middle2_en='".$lines2_en."',middle='".$lines2."',middle_tw='".$lines2_tw."',middle_en='".$lines2_en.( "' where id=".$id );
								wager_update($mysql, $id);
								break;
				case 9 :
								$team = explode( "&nbsp;&nbsp;", $middle[$count - 2] );
				...
				case 10 :
								...
								$lines2_en = $middle_en1."<FONT color=#cc0000>".$m_place_en."</FONT>&nbsp;".$bottom1_en."@&nbsp;<FONT color=#cc0000><b>".$rate."</b></FONT>";
								$auth_code = md5( $lines2_tw.$gold_d.$mtype );
								$mysql = "update web_db_io set auth_code='".$auth_code."',vgold=0,m_place='{$m_place_en}',result_type=0,m_result=0,a_result=0,result_c=0,result_a=0,result_s=0,status=0,gwin='{$gwin}',m_rate='{$rate}',mtype='".$mtype."',middle='".$lines2."',middle_tw='".$lines2_tw."',middle_en='".$lines2_en.( "' where id=".$id );
								wager_update($mysql, $id);
								break;
				case 30 :
								$pan = substr( $row['M_Place'], 1, strlen( $row['M_Place'] ) );
...
case 2 :
				...
				$sql = "update web_db_io set vgold=0,m_result=0,result_c=0,a_result=0,cancel=1,result_a=0,result_s=0,result_type=1 where id=".$id;
				mysql_query( $sql );
				echo "<script languag='JavaScript'>self.location='wager_list.php?uid=".$uid."&username={$username}&gdate={$gdate}'</script>";
				break;
case 3 :
				...
				break;
case 4 :
				$sql = "select betscore,m_name,pay_type from web_db_io where id=".$id;
				$result = mysql_query( $sql );
				$row = mysql_fetch_array( $result );
				if ( $row['pay_type'] == 1 )
				{
				...
				$sql = "update web_db_io set vgold=0,m_result=0,result_c=0,a_result=0,status=0,result_a=0,result_s=0,result_type=0 where id=".$id;
				mysql_query( $sql );
				echo "<script languag='JavaScript'>self.location='wager_list.php?uid=".$uid."&username={$username}&gdate={$gdate}'</script>";
}
...
while ( $row = mysql_fetch_array( $result ) )
{
				...
				echo $row['BetType'];
				echo "          \t";
				echo "<br><font color=green>".$ODD[$row['odd_type']]."</font>";
				switch ( $row['danger'] )
				{
				case 1 :
				...
				if (in_array($row['linetype'],array(2,3,12,13,9,10,19,30))){
					echo "<a href='".$url."'>�Ե�</a> / 
					<a href='wager_edit.php?uid=$uid&id=$row[id]&username=$username&gdate=$gdate'>�޸�</a> / ";
				}
				//��Ӯ������ֻ�޸Ĳ��ܶԵ�
				if (in_array($row['linetype'],array(1,11,51,52,17,8))){
					echo "<a href='wager_edit.php?uid=$uid&id=$row[id]&username=$username&gdate=$gdate'>�޸�</a> / ";
				}
				echo "  <a href=javascript:Del(\"wager_list.php?uid=";
				echo $uid;
				echo "&id=";
				echo $row[id];
				echo "&active=3&username=";
				echo $username;
				echo "&gdate=";
				echo $gdate;
				echo "\")>ɾ��</a></td>\r\n        </tr>\r\n        ";
