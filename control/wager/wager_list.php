...
case 1 :
				...
				case 2 :
								...
								{
												$bottom1_tw = "<font color=red>-&nbsp;</font><font color=gray>[材1竊]</font>&nbsp;";
								...
								{
												$bottom1_tw = "<font color=red>-&nbsp;</font><font color=gray>[材2竊]</font>&nbsp;";
								...
								{
												$bottom1_tw = "<font color=red>-&nbsp;</font><font color=gray>[材3竊]</font>&nbsp;";
								...
								{
												$bottom1_tw = "<font color=red>-&nbsp;</font><font color=gray>[材4竊]</font>&nbsp;";
...
while ( $row = mysql_fetch_array( $result ) )
{
				...
				if (in_array($row['linetype'],array(2,3,12,13,9,10,19,30))){
					...
					<a href='wager_edit.php?uid=$uid&id=$row[id]&username=$username&gdate=$gdate'>修改</a> / ";
				}
				//独赢、串，只修改不能对调
