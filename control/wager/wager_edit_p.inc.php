...
function p3_update($row,$admin_name)
{
	...
	$sql = "update web_db_io set auth_code='{$auth_code}',vgold=0,result_type=0,m_result=0,a_result=0,result_c=0,result_a=0,result_s=0,status=0, BetTime='{$BetTime}',BetScore='{$BetScore}',gwin='{$gwin}',mtype='$mtype',m_place='$m_place',m_rate='{$m_rate}',middle='$middle',middle_tw='$middle_tw',middle_en='$middle_en',BetIP='$BetIP',more='$more',G_Name='".$admin_name."',G_Type=2 where id='$row[ID]' ";
