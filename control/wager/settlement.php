...
$is_h = strpos($row['Middle'],'[上半]')!==false;
$matche_type = '';
$matche_table = '';
$sqladd='';
...
if ($matche_type==''){
	echo "<script>alert('不支持此类!$row[LineType]');location='javascript:history.back(1)';</script>";
}
...
<table width="802" border="0" cellspacing="1" cellpadding="8" class="m_tab" bgcolor="#000000">
  <tr class="m_title_ft">
	  ...
	  <td width="90" align="center">单注种类</td>
...
<table width="" border="0" cellspacing="1" cellpadding="8" class="m_tab" bgcolor="#000000">
  <tr class="m_title_ft">
	  <td width="90" align="center">输赢金额</td>
	  <td width="90" align="center">会员</td>
	  <td width="90" align="center">代理商</td>
	  <td width="90" align="center">总代理</td>
	  <td width="90" align="center">股东</td>
  </tr>
  <tr class="m_rig">
...
<table width="695" border="0" cellspacing="1" cellpadding="8" class="m_tab" bgcolor="#000000">
  <tr class="m_title_ft">
	  ...
	  <td width="357" align="center">球队</td>
	  <td width="90" align="center"><?=$is_h?'上半':''?>比分</td>
  </tr>
  <tr class="m_rig">
	  <td align="center" rowspan=2><?=str_replace(' ','<BR>',$match['m_start'])?></td>
	  <td align="center" rowspan=2><?=$matche_type?></td>
	  <td align="right"><?=$match['mb_team']?> <font color=blue>(主队)</font> </td>
	  <td align="center"><input size=4 type="text" name="mb_inball" value="<?=$match['mb_inball']?>"></td>
  </tr><tr class="m_rig">
	  <td align="right"><?=$match['tg_team']?> <font color=blue>(客队)</font> </td>
...
<table width="802" border="0" cellspacing="0" cellpadding="0" class="m_tab" bgcolor="#000000">
  <tr class="m_rig">
	  <td align="center">
		<?=$is_settlement ? '<BR><font color=#ff0000>已成功结算</font><BR>': ''?>
		<BR><INPUT TYPE="submit" value=" 结算 " <?=$is_settlement ? 'disabled=true' :''?>>
		&nbsp; &nbsp; &nbsp;<INPUT TYPE="button" VALUE=" 返回 " ONCLICK="self.location='<?=$referer?>'">
		<BR><BR>注：输入的比分只对本次结算有效
		</td>
  </tr>
</table>
