...
case 'OU':
	...
	$sql="SELECT m_league_tw as m_league FROM `foot_match` WHERE r_show=1 and `m_start` > now( ) and `m_Date` ='$mDate' group by m_league order by display ";
	break;
case 'HOU':
	$mysql="SELECT * FROM `foot_match` WHERE mid%2=0 and r_show=1  and `m_start` > now( ) and `m_Date` ='$mDate'";
	$sql="SELECT m_league_tw as m_league FROM `foot_match` WHERE mid%2=0 and r_show=1 and `m_start` > now( ) and `m_Date` ='$mDate' group by m_league order by display ";
	break;
case 'RE':
	$mysql="SELECT * FROM `foot_match` WHERE RE_Show=1 and `m_start` > now( ) and `m_Date` ='$mDate'";
	$sql="SELECT m_league_tw as m_league FROM `foot_match` WHERE re_show=1 and `m_start` > now( ) and `m_Date` ='$mDate' group by m_league order by display ";
	break;
case 'PD':
	$mysql="SELECT * FROM `foot_match` WHERE pd_show=1 and `m_start` > now( ) and `m_Date` ='$mDate'";
	$sql="SELECT m_league_tw as m_league FROM `foot_match` WHERE pd_show=1 and `m_start` > now( ) and `m_Date` ='$mDate' group by m_league order by display ";
	break;
case 'HPD':
	$mysql="SELECT * FROM `foot_match` WHERE mid%2=0 and pd_show=2 and `m_start` > now( ) and `m_Date` ='$mDate'";
	$sql="SELECT m_league_tw as m_league FROM `foot_match` WHERE pd_show=2 and `m_start` > now( ) and `m_Date` ='$mDate' group by m_league order by display ";
	break;
case 'F':
	$mysql="SELECT * FROM `foot_match` WHERE f_show=1 and `m_start` > now( ) and `m_Date` ='$mDate'";
	$sql="SELECT m_league_tw as m_league FROM `foot_match` WHERE f_show=1 and `m_start` > now( ) and `m_Date` ='$mDate' group by m_league order by display ";
	break;
case 'T':
	$mysql="SELECT * FROM `foot_match` WHERE t_show=1 and `m_start` > now( ) and `m_Date` ='$mDate'";
	$sql="SELECT m_league_tw as m_league FROM `foot_match` WHERE t_show=1 and `m_start` > now( ) and `m_Date` ='$mDate' group by m_league order by display ";
	break;
case 'P':
	$mysql="SELECT * FROM `foot_match` WHERE p_show=1 and `m_start` > now( ) and `m_Date` ='$mDate'";
	$sql="SELECT m_league_tw as m_league FROM `foot_match` WHERE p_show=1 and `m_start` > now( ) and `m_Date` ='$mDate' group by m_league order by display ";
	break;
case 'PL':
...
case "RE":
	...
	break;
case "PD":
	$sql1 = "select mid,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,m_league_TW as league,ShowType,if(PD_Show=1,'Y','N') as pd_show from foot_match where pd_show=1 and `m_start` > now( ) AND `m_Date` ='$mDate' ".$sleague." order by m_start,mid limit $offset,40";
