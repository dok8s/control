  ...
  with(obj_table)
  {
   ...
   for(i=0; i<data_amount; i++)
   {
    ...
    with(nowTR)
    {
     ...
     nowTD = insertCell();
     nowTD.innerHTML = GameData[i][1];
     //nowTD.innerHTML = '<A href=\"javascript:\" onClick=\"show_detail(\''+GameData[i][0]+'\');\"><font color=black>'+GameData[i][1]+'</font></A>' ;
     //聯盟
     nowTD = insertCell();
     ...
     if(GameData[i][7] == 'H') //強隊是主隊
     {
      ...
      $ratio_c = '&nbsp';
      $ioratio_h = GameData[i][11];
      $ioratio_h = '<A href=\"javascript:\" onClick=\"show_detail_re(\''+GameData[i][0]+'\');\">'+GameData[i][11]+'</A>' ;
      //'<A href=\"#\" onClick=\"window.open(\'FT_chg_ioratio.php?call=ou&type=H&rtype=RE&ltype=1&game_id='+GameData[i][0]+'\');\">'+GameData[i][11]+'</A>';
      $ioratio_c = GameData[i][12];
     }
     else  //強隊是客隊
     {
      ...
      $ioratio_h = GameData[i][11];
      $ioratio_c = GameData[i][12];
      $ioratio_c = '<A href=\"javascript:\" onClick=\"show_detail_re(\''+GameData[i][0]+'\');\">'+GameData[i][12]+'</A>' ;
