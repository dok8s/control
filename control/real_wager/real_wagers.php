...
function show_detail_re(gid){
	document.all.re_window.style.position='absolute';
	document.all.re_window.style.top=document.body.scrollTop+event.clientY+40;
	document.all.re_window.style.left=document.body.scrollLeft+event.clientX;
	line_form.gid.value=gid;
	line_form.sid.value=parent.sid;
	line_form.set_acc.value=document.all.set_account.value;
	document.all.re_window.style.visibility='visible';
	line_form.submit();
}
function show_one(){
...
<form name="line_form" id=line_form action="real_wagers_var_pl_detail.php" method="post" target=showdata>
	<div class="t_div" id="re_window" style="visibility:hidden;position: absolute;">
		<input type=hidden name='uid' value='<?=$uid?>'>
		<input type=hidden name='gid' value=''>
		<input type=hidden name='sid' value=''>
		<input type=hidden name='set_acc' value=''>
