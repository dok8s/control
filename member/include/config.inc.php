...
$str="!and|update|from|where|order|*|delete|\'|insert|into|values|create|table|database|script|iframe|<>|onload|\"|eval|base64_decode";  //非法字符 
...
{
				echo "<html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=big5\"></head>IP不合法.<br>您所在的<font style=\"background-color: #3399FF\"><B>IP</B></font>位置:<font style=\"background-color: #3399FF\"><B>".$ip_addr."</B></font>.<br>不允许进入，请联系相关人员.<br></html>";
				exit( );
}
